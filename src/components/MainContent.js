  ...
  return (
    <div className="main-content-container">
      ...
      <div className="sub-header-wrapper">
        <h4>- Article about tech</h4>
        <hr />
      </div>

      <div className="top-main-content-wrapper">
        <p>
      ...
      <div className="middle-content-wrapper">
        <div className="content-wrapper">
          <div className="content-header">
            ...
            <p>
              ...
              et odit impedit dolores totam ullam ab quaerat unde cum, numquam
              nihil non, ducimus quos at aspernatur fuga vel cupiditate? Omnis
              laboriosam sed perferendis quaerat cupiditate, eos veniam quasi
              nesciunt sit iste unde ipsam laudantium natus eligendi adipisci
              illum nulla debitis. Numquam culpa cupiditate tempore quis natus,
              modi vero vel.
            </p>
            <hr />
          </div>
        ...
        <img
          ...
          src="https://images.unsplash.com/photo-1504639725590-34d0984388bd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
          alt="tech with glasses"
        />
        <img
